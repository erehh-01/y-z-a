...
const (
	UserService_CreateUser_FullMethodName = "/uspb.UserService/CreateUser"
	UserService_LoginUser_FullMethodName  = "/uspb.UserService/LoginUser"
	UserService_BanUser_FullMethodName    = "/uspb.UserService/BanUser"
)
...
func (c *userServiceClient) BanUser(ctx context.Context, in *BanUserRequest, opts ...grpc.CallOption) (*BanUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserService_BanUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "uspb/user_service.proto",
}
